              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('Title: T-Shirt for Male',style: TextStyle(fontSize: publicProvider.isWindows?size.height*.03:size.width*.03,) ,

                    ),
                  ),
                  Padding(
                      padding: const EdgeInsets.only(top: 8.0,bottom: 8.0),
                      child:  Text('Description: Same Day Printing, Cheap Price, Place Your Order Today. Best Quality Printing. Place Your Order online, Choose Local pick up or Free Shippin on Check out Page. Call Now To Get Quote. Best Price Guratantee. Amenities: All-Inclusive Pricing, Free Expert Help, Free Design Review.',style: TextStyle(fontSize:  publicProvider.isWindows?size.height*.03:size.width*.03,) ,)
                  ),
                  Padding(
                      padding: const EdgeInsets.only(top: 8.0,bottom: 8.0),
                      child:  Text('Price: 250 tk',style: TextStyle(fontSize:  publicProvider.isWindows?size.height*.03:size.width*.03,) ,)
                  ),
                  Padding(
                      padding: const EdgeInsets.only(top: 8.0,bottom: 8.0),
                      child:  Text('Size: S, M, L ,XL, XXL,XXXL',style: TextStyle(fontSize:  publicProvider.isWindows?size.height*.03:size.width*.03,) ,)
                  ),

                  Padding(
                      padding: const EdgeInsets.only(top: 8.0,bottom: 8.0),
                      child:  Text('Profit Amount: 10 %',style: TextStyle(fontSize:  publicProvider.isWindows?size.height*.03:size.width*.03,) ,)
                  ),
                  Padding(
                      padding: const EdgeInsets.only(top: 8.0,bottom: 8.0),
                      child:  Text('Category: T-Shirt',style: TextStyle(fontSize:  publicProvider.isWindows?size.height*.03:size.width*.03,) ,)
                  ),

                  Padding(
                      padding: const EdgeInsets.only(top: 8.0,bottom: 8.0),
                      child:  Text('Subcategory: Baby',style: TextStyle(fontSize:  publicProvider.isWindows?size.height*.03:size.width*.03,) ,)
                  ),

                  Padding(
                      padding: const EdgeInsets.only(top: 8.0,bottom: 8.0),
                      child:  Text('Color: Green, Red, Blue',style: TextStyle(fontSize:  publicProvider.isWindows?size.height*.03:size.width*.03,) ,)
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          Text('Color :',style: TextStyle(color: Colors.black,fontSize:  publicProvider.isWindows?size.height*.04:size.width*.04,),),
